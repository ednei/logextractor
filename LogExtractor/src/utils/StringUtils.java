...
public class StringUtils {
	...
	public static RegExprRecord simpleExpand(String logid) throws Exception {
		throw new Exception("simpleExpand is waiting for understand and implementation");
	...
	public static RegExprRecord[] getExpandedRegExpr(String logid) throws Exception {
//		return simpleExpand(logid);
		throw new Exception("Wait for understand and implementation");
		/*RegExprRecord rec = DbUtils.findLogEntry(logid);
	...
	private static RegExprRecord[] expandAll(RegExprRecord[] recs) throws Exception {
	...
	@SuppressWarnings("unused")
	private static RegExprRecord[] resolveSubclasses2levels(RegExprRecord[] l1results) throws Exception {
	...
	private static RegExprRecord[] resolveSubclasses(RegExprRecord rec) throws Exception {
		LOG.fine("Before resolving:: " + rec);
		throw new Exception ("resolveSubclasses waiting for understand and implementation");
		/*
	...
	@SuppressWarnings("unused")
	private static RegExprRecord[] expandAllOneLevel(RegExprRecord[] recs) throws Exception {
	...
	private static RegExprRecord expandSubClassOneLevel(RegExprRecord rec) throws Exception{
		throw new Exception ("expandSubClassOneLevel is waiting for understand and implementation");
		/*
...
//	}
	...
	public static RegExprRecord getExpandedRegExpr(RegExprRecord rec) throws Exception{
		throw new Exception("RegExprRecord is waiting for understandment and implementation");
		/*
		if (rec==null) {
			return null;
		}
